...
<body class="theme-blush right_icon_toggle ls-toggle-menu">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account"></i><span>Profile</span></a>
                    <ul class="ml-menu">
                        <li><a href="<?php echo base_url(); ?>account/setup_user">Profile</a></li>
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>ATM</span></a>
                    <ul class="ml-menu">
                        <!-- <li><a href="<?php echo base_url(); ?>log/terminal">Log Terminal</a></li> -->
                        <li><a href="<?php echo base_url(); ?>atm/monitoring">Terminal Monitoring</a></li>
                        <li><a href="<?php echo base_url(); ?>atm/cardretain">Card Retain</a></li>
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>Postilion Cardbase</span></a>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>CRM</span></a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="<?php echo base_url(); ?>crm/transaction">Terminal Monitoring Transaction</a></li>
                            <li><a href="<?php echo base_url(); ?>crm/batchviewercrm">Batch Viewer CRM</a></li>
                            <li><a href="<?php echo base_url(); ?>crm/saldotermcrm">Saldo Terminal CRM</a></li>
    ...
    <script src="<?php echo base_url() ?>assets/bundles/postilion_saldo_crm.js"></script>
